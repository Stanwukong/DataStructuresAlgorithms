 ...
 * 
 * In the class, create a getter to obtain the temperature in Celsius and a setter to set the
 ...
 * 
 * This is the power of a getter and a setter. You are creating an API for another user, who can
 * get the correct result regardless of which one you track.
 * 
